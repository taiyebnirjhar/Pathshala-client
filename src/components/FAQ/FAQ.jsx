      ...
      {!navToggler && (
        <section className="bg-white ">
          <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <h2 className="mb-8 text-4xl tracking-tight font-extrabold brand_primary__color ">
              Frequently asked questions
            </h2>
            <div className="grid pt-8 text-left border-t-2 border-pink-400 md:gap-16  md:grid-cols-2">
              <div>
                <div className="mb-10">
                  <h3 className="flex items-center mb-4 text-lg font-medium brand_primary__color ">
                    <svg
                      className="flex-shrink-0 mr-2 w-5 h-5 text-pink-400 "
                      fill="currentColor"
                      viewBox="0 0 20 20"
